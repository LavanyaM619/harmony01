...
import { FaBuilding, FaMapMarkerAlt, FaPhone, FaUser, FaClock, FaEdit, FaTrash, FaHome, FaAddressBook, FaCodeBranch, FaRoute, FaCalendarAlt, FaSignOutAlt ,FaCog} from 'react-icons/fa';
